...
#define MAX_DISTANCE 400 // Max Distance

NewPing sonar(TRIGGER_PIN, ECHO_PIN, MAX_DISTANCE); // Using the NewPing.h Library to Intializing
...
void loop()
{
  //Calculating the Distance measured by the HC-SR04 Sensor and saving it is to a variable called distance
  ...
  delay(500);
    if(distance >= 5)//Break from the loop after the Distance is greater than equal to 5
    {
      break;
    }
  }  
